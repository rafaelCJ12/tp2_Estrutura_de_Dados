...
int main(void) {
    ...
    Lista_generica *lista_pacientes = cria_lista(), *fila_laudo = cria_lista();
    ...
    while(i < 43200) {
        ...
        if(j > 9000) {
            condicao = realloc(condicao, 18000 * sizeof(int));
            vetor_tempos = realloc(vetor_tempos, 18000 * sizeof(int));
            vetor_tempos2 = realloc(vetor_tempos2, 18000 * sizeof(int));
            vetor_tempos3 = realloc(vetor_tempos3, 18000 * sizeof(int));
            
            if(j > 18000) {
                condicao = realloc(condicao, 43200 * sizeof(long int));
                vetor_tempos = realloc(vetor_tempos, 43200 * sizeof(long int));
                vetor_tempos2 = realloc(vetor_tempos2, 43200 * sizeof(long int));
                vetor_tempos3 = realloc(vetor_tempos3, 43200 * sizeof(long int));
            }
